          ...
          <div className="flex flex-col sm:flex-row mb-6 sm:mb-8 bg-transparent sm:bg-transparent p-0 sm:p-1 rounded-2xl sm:rounded-full w-full gap-2 sm:gap-0 sm:border-0">
            {tabs.map((tab) => (
              <button
                ...
                className="w-full sm:flex-1 py-3 sm:py-2 rounded-xl sm:rounded-full text-sm font-semibold transition-all duration-200 text-center border sm:border-0"
                style={
                  activeTab === tab.id
                    ? {
                        background: 'linear-gradient(92.62deg, #FA2329 0.91%, #B10D1C 99.09%)',
                        ...
                        boxShadow: '0 4px 12px rgba(250, 35, 41, 0.2)',
                      }
                    : {
                        background: '#ffffff',
                        color: '#666666',
