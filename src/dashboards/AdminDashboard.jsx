...
function AdminDashboard() {
    ...
    // Company Data (Strictly Email, Company Name, and Address)
    const companies = [
        { name: "Arsenaltech", email: "contact@arsenaltech.com", address: "Bengaluru, Karnataka" },
        { name: "Apexon", email: "info@apexon.com", address: "Bharuch, Gujarat" },
        { name: "Techgenix Technology Pvt. Ltd.", email: "hr@techgenix.com", address: "Surat, Gujarat" },
        { name: "Honeywell", email: "careers@honeywell.com", address: "Ahmedabad, Gujarat" }
    ];

    // HR/Recruiter Data (Strictly Name and Email)
    const recruiters = [
        { name: "Marianna I. Ward", email: "marianna.ward@raynorstamm.com" },
        { name: "Dora J. Coburn", email: "dora.coburn@raynorstamm.com" }
    ];

    return (
        /* Changed page background to match your signature pink linear gradient */
        <div
            ...
            <div className="max-w-full mx-auto bg-white rounded-3xl border border-rose-100/40 shadow-[0_10px_30px_rgba(0,0,0,0.04)] overflow-hidden">
                ...
                <div className="p-8 md:p-12 border-b border-rose-100/40 bg-white/60 backdrop-blur-sm">
                    <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">
                        Build & Manage Your Hiring Network          </h1>
                    <p className="mt-2 text-sm md:text-base text-slate-500 font-medium tracking-wide">
                        Create and manage company accounts, assign HR representatives, oversee recruiter access, and streamline hiring workflows while maintaining complete control over your recruitment ecosystem.    Efficiently manage company information, HR assignments, recruiter profiles, and access permissions. Ensure every company is connected with the right hiring team to support smooth recruitment operations.      </p>
                </div>
                ...
                <div className="p-6 md:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start bg-white">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 text-xs text-slate-500 font-medium pt-0.5">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        {/* Recruiters/HR List Container */}
                        <div className="bg-white rounded-xl p-5 border border-slate-200/80 shadow-sm space-y-4">
                            <h2 className="text-xs uppercase tracking-widest font-bold text-slate-400 px-1">Active Recruiters</h2>

                            <div className="divide-y divide-slate-100">
                                {recruiters.map((hr, index) => (
                                    <div key={index} className="py-3 first:pt-0 last:pb-0 flex items-center gap-3.5">
                                        {/* Minimalist Profile Initials Badge */}
                                        <div className="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center font-bold text-xs text-slate-600 shrink-0">
                                        ...
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-xs text-slate-500 font-medium flex items-center gap-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                                {hr.email}
                                            </p>
                                        </div>
                                    </div>
...
Assign Recruiter to Company                            </button>
                        </div>
