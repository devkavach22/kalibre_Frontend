...
export default function AddJobModal({ onClose, onCreateJob }) {
    ...
    const [form, setForm] = useState({
        ...
        customQuestion: "", addedQuestions: [],
        aboutRole: "", responsibilities: [],
        newResponsibility: "",
        emailNotif: false, smsAlerts: false, whatsappUpdates: false, interviewReminders: false,
        benefits: { healthInsurance: false, annualBonus: false, providentFund: false, paidLeaves: false, flexibleHours: false, workFromHome: false },
                ...
                return (
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                            <div><Label text="Your Company Name" required /><Input placeholder="Your company name" value={form.companyName} onChange={v => set("companyName", v)} allowOnly="all" /></div>
                            <div><Label text="Job title" required /><Input placeholder="Ex. iOS Developer" value={form.jobTitle} onChange={v => set("jobTitle", v)} allowOnly="all" /></div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                            <div>
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    options={["Any", "Male", "Female", "Non-Binary"]}
                                />
                            </div>
                        </div>
                        <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 items-start">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2 mb-2 min-h-[36px] items-center">
                                    ...
                                    {form.languages.length === 0 && <span className="text-gray-400 text-sm">No language selected</span>}
                                </div>
                                <div className="w-full sm:w-48 flex-shrink-0">
                                    <Select 
                                        placeholder="Add language" 
                                        value="" 
                                        onChange={v => { if (v && !form.languages.includes(v)) set("languages", [...form.languages, v]) }} 
                                        options={dynamicLangOptions} 
                                    />
                                </div>
                            </div>
                        </div>
            ...
            case 3: return (
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
                        <div><Label text="Notice Period" required /><Select placeholder="select" value={form.noticePeriod} onChange={v => set("noticePeriod", v)} options={["Immediate", "15 days", "30 days", "60 days", "90 days"]} /></div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
                        ...
                        <div><Label text="Job Location" required /><Input placeholder="Enter job location" value={form.jobLocation} icon="📍" onChange={v => set("jobLocation", v)} allowOnly="all" /></div>
                    </div>
                    <div>
            ...
            case 7: return (
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div>
                        ...
                        <Textarea placeholder="Write a brief overview about your company..." value={form.companyOverview} onChange={v => set("companyOverview", v)} rows={4} />
                    </div>
                </div>
            );
            case 8: return (
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="bg-green-50 border border-green-100 rounded-2xl p-4 md:p-5">
                        ...
                        <p className="text-xs md:text-sm text-green-600">Review your job posting details before publishing.</p>
                    </div>
                    <div className="space-y-1">
                        {[
                            { label: "Job Title", value: form.jobTitle || "—" },
                            { label: "Company", value: form.companyName || "—" },
                            { label: "Selected Dept.", value: form.department || "—" },
